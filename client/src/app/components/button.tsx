...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    "font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all";
  ...
  const variantStyles = {
    ...
    outline:
      "rounded-[10px] border border-primary1 text-primary1 hover:bg-primary1 hover:text-white focus:ring-primary1 cursor-pointer",
