...
export default function LandingPage() {
    ...
    <div className="min-h-screen flex flex-col overflow-hidden">
      ...
      <section className="-mt-10 flex flex-col items-center justify-center px-6 py-20 md:px-16 lg:px-28 space-y-28">
        ...
        <div className="text-center max-w-3xl">
          <h2 className="font-rubik text-4xl sm:text-5xl font-extrabold mb-4">
            ABOUT US
          </h2>
          <p className="font-raleway text-gray-700 leading-relaxed text-md md:text-xl mb-8 my-10">
            ...
            Edition (ICpEP.SE) CIT-U Chapter is a recognized organization of
            Computer Engineering students that fosters learning, collaboration,
            and innovation through seminars, workshops, and student-led
            initiatives.
          </p>
        ...
        <div className="mt-50 flex mb-10 flex-col lg:flex-row items-center justify-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2">
            <h2 className="font-rubik text-3xl sm:text-4xl font-extrabold mb-5">
              WHY JOIN ICPEP.SE?
            </h2>
            <p className="font-raleway text-gray-700 mb-6 text-xl sm:text-2xl">
              Discover the opportunities that await you as part of a community
              dedicated to Computer Engineering students.
            </p>
            ...
            <ul className=" mt-15 space-y-10">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-raleway text-gray-600 text-lg">
                    Be part of a community where your passion connects you to
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-raleway text-gray-600 text-lg">
                    Join exclusive seminars, trainings, and workshops that make
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="font-raleway text-gray-600 text-lg">
                    Take the chance to lead projects, events, and teams while
      ...
      <section className="relative w-full flex flex-col items-center py-12 overflow-visible mb-20">
        <div className="absolute inset-0 z-0 opacity-60">
          <div className="orbit animate-blob-1">
            <div className="blob bg-sky-300 "></div>
          </div>
          <div className="orbit animate-blob-2">
            <div className="blob bg-indigo-300"></div>
          </div>
          <div className="orbit animate-blob-3">
            <div className="blob bg-blue-300"></div>
          </div>
        </div>
        <div className="text-center max-w-4xl mx-auto mb-15 z-10">
          <h2 className="font-rubik text-3xl md:text-4xl font-extrabold mb-4 tracking-tight text-black">
            TESTIMONIALS
          </h2>
          <p className="font-raleway text-gray-700 text-base md:text-lg leading-relaxed mt-5">
            Discover how ICpEP.SE has impacted students through their stories
            and feedback.
          </p>
        </div>
      ...
      {/*======= Faculty & Officers =======*/}
      <section className="w-full py-16 overflow-hidden mb-20 z-10">
  ...
  .animate-blob-1 { animation: orbit-1 5s linear infinite; }
  .animate-blob-2 { animation: orbit-2 5s linear infinite; }
  .animate-blob-3 { animation: orbit-3 5s linear infinite; }
