                        ...
                        <div className="flex w-full select-none">
                            ...
                            <div className="flex-1 border-l border-r border-gray-200">
                                {times.map((hour, index) => {
                                    ...
                                    // Check availability (now always false since array is empty)
                                    ...
                                    return (
                                        <div key={hour} className="h-16 border-t border-gray-200 w-full relative bg-white">
                                            ...
                                            <div 
                                                onClick={onSlotClick} // Triggers bounce
                                                className={`h-1/2 w-full cursor-pointer transition-colors duration-100 border-b relative
                                                    ${isSlot1Available 
                                                        ? 'bg-sky-200 border-b-2 border-white' 
                                                        : 'hover:bg-gray-50 border-gray-100 border-dashed'}`}
                                            >
                                            </div>
