...
const announcements = [
  ...
  },
  {
    ...
    awardees: [
      ...
      { name: "Sarah Mae Rodriguez", program: "", year: "4th Year", award: "Innovation and Research Award" },
      { name: "Miguel Angelo Fernandez", program: "", year: "2nd Year", award: "Community Service Excellence" },
    ],
  },
  {
    id: "3",
...
export default function AnnouncementDetailPage({ params }: { params: { id: string } }) {
  ...
  const isEvent = ['event', 'seminar', 'workshop'].includes(announcement.type.toLowerCase());

  return (
    <div className="min-h-screen bg-gray-50">
      <Header />
      <DetailHeader announcement={announcement} onBack={handleBack} />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            <HeroImage imageUrl={announcement.imageUrl} title={announcement.title} />
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {isMeeting && (
              <MeetingAttendanceCard onViewFull={() => setShowFullAttendance(true)} />
            )}
